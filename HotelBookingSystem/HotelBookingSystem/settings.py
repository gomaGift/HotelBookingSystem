...
SECRET_KEY = 'django-insecure-u*&06y7+%yp1mft#i*xciu%q0b3b_6pof(pbc6)gc*@$2!8yl_'
...
AUTHENTICATION_BACKENDS = [
    ...
    'users.backends.CustomUserEmailOrPhoneBackend',       # Custom phone number authentication backend
]
